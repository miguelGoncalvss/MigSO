...
isr_common_stub:
    pusha               ; Salva registradores gerais (eax, ecx, edx, ebx, esp, ebp, esi, edi)
...
; ============================================================
; ISR do Timer PIT (IRQ 0 / Vetor 32)
; ============================================================
global _timer_isr_wrapper
