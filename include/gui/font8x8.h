...
// Fonte bitmap monocromatica padrao 8x8 (ASCII 0..127)
static const uint8_t font8x8_basic[128][8] = {
    // 0-31 (Caracteres Especiais)
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // 0 (NUL)
    {0x30, 0x78, 0xCC, 0xCC, 0xFC, 0xCC, 0x78, 0x30}, // 1 (Apple/Maca)
    {0x3C, 0x42, 0xA5, 0x81, 0xA5, 0x99, 0x42, 0x3C}, // 2
    {0x00, 0x66, 0xFF, 0xFF, 0x7E, 0x3C, 0x18, 0x00}, // 3 (Coracao)
    {0x00, 0x18, 0x3C, 0x7E, 0xFF, 0x7E, 0x3C, 0x18}, // 4 (Ouro)
    {0x00, 0x18, 0x3C, 0x7E, 0x18, 0x7E, 0x3C, 0x18}, // 5 (Paus)
    {0x00, 0x18, 0x3C, 0x7E, 0xFF, 0x18, 0x18, 0x00}, // 6 (Espadas)
    {0x00, 0x00, 0x18, 0x3C, 0x3C, 0x18, 0x00, 0x00}, // 7 (Ponto)
    ...
    {0x3C, 0x66, 0x66, 0x3C, 0x18, 0x7E, 0x18, 0x18}, // 12
    {0x3F, 0x33, 0x3F, 0x30, 0x30, 0x70, 0xF0, 0xE0}, // 13
    {0x3F, 0x33, 0x3F, 0x33, 0x3F, 0x30, 0x70, 0x60}, // 14
    {0x00, 0x18, 0x3C, 0x7E, 0x18, 0x18, 0x18, 0x00}, // 15
    {0x10, 0x30, 0x70, 0xFF, 0x70, 0x30, 0x10, 0x00}, // 16
    {0x08, 0x0C, 0x0E, 0xFF, 0x0E, 0x0C, 0x08, 0x00}, // 17
    ...
    {0x3E, 0x63, 0x38, 0x6C, 0x3E, 0xDB, 0x77, 0x00}, // 21
    ...
    {0x00, 0x00, 0x7E, 0x7E, 0x7E, 0x00, 0x00, 0x00}, // 28
    {0x00, 0x24, 0x66, 0xFF, 0x66, 0x24, 0x00, 0x00}, // 29
    {0x00, 0x18, 0x3C, 0x7E, 0x3C, 0x18, 0x00, 0x00}, // 30
    {0x00, 0x3C, 0x7E, 0xFF, 0x7E, 0x3C, 0x00, 0x00}, // 31

    // 32-64 (ASCII Imprimivel)
    ...
    {0x3C, 0x66, 0xCE, 0xDE, 0xF6, 0x66, 0x3C, 0x00}, // 48 '0'
    {0x18, 0x38, 0x18, 0x18, 0x18, 0x18, 0x7E, 0x00}, // 49 '1'
    {0x3C, 0x66, 0x06, 0x1C, 0x30, 0x60, 0x7E, 0x00}, // 50 '2'
    {0x3C, 0x66, 0x06, 0x1C, 0x06, 0x66, 0x3C, 0x00}, // 51 '3'
    {0x0C, 0x1C, 0x3C, 0x6C, 0xFE, 0x0C, 0x1E, 0x00}, // 52 '4'
    ...
    {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}  // 127 (Solid Block)
};
